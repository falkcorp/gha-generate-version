...
# gha-generate-version — Additional Context
...
GHA composite action: version string generation. Language: Shell/YAML.

## Critical constraints

- This is a composite GitHub Action — `action.yml` is the entry point.
- Shell scripts in `src/` implement version generation logic.
